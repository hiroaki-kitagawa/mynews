    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto">
                <h2>ニュース編集</h2>
                <form action="{{ action('Admin\NewsController@update', $request->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @if (count($errors) > 0)
                        <ul>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <textarea name="body" rows="20" class="form-control">{{ $news_form->body }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="body" class="col-md-2">画像</label>
                        <div class="col-md-10">
